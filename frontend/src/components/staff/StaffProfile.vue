  ...
  <div class="row justify-content-center">
    <div class="col-md-6">
      <div class="card border-0 shadow-sm">
        ...
        <div class="card-body">
          <div v-if="msg" class="alert py-2 small" :class="msgType==='success'?'alert-success':'alert-danger'">
            <i :class="msgType==='success'?'bi bi-check-circle-fill':'bi bi-exclamation-triangle-fill'" class="me-1"></i>
            {{ msg }}
          </div>
          ...
          <div class="text-center mb-4">
            ...
            <div class="badge bg-success px-3 py-2 d-block mx-auto" style="width:fit-content">
              Trek Staff
            </div>
          </div>
          ...
          <div class="mb-3">
            ...
            <input class="form-control" v-model="profile.name" placeholder="Your name" />
          </div>
          <div class="mb-3">
